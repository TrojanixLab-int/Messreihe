...
class MessreiheApp:
    ...
    def setup_ui(self):
        ...
        self.action_btns = {}
        confs = [
            ("odl", "ADER - Ambient Dose Equivalent Rate", "Σ", ["time (s)", "counts", "CPM", "%", "Sv/h (ADER)"]),
            ("alpha", "Alpha nuclides", "α", ["time (s)", "counts", "CPM", "%", "Gy/h (α+β+γ)", "Gy/h (α)"]),
            ("beta", "Beta particles", "β", ["time (s)", "counts", "CPM", "%", "Gy/h (β+γ)", "Gy/h (β)"]),
            ("gamma", "Gamma radiation", "γ", ["time (s)", "counts", "CPM", "%", "Gy/h ((β)+γ)", "Gy/h (γ)"])
        ]
