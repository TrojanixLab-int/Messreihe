...
class MessreiheApp:
    ...
    def setup_ui(self):
        ...
        self.action_btns = {}
        confs = [
            ("odl", "EDMA - Équivalent de Dose Ambiant", "Σ", ["Temps (s)", "Coups", "CPM", "%", "Sv/h (EDMA)"]),
            ("alpha", "Nucléides Alpha", "α", ["Temps (s)", "Coups", "CPM", "%", "Gy/h (α+β+γ)", "Gy/h (α)"]),
            ("beta", "Particules Bêta", "β", ["Temps (s)", "Coups", "CPM", "%", "Gy/h (β+γ)", "Gy/h (β)"]),
            ("gamma", "Rayonnement Gamma", "γ", ["Temps (s)", "Coups", "CPM", "%", "Gy/h ((β)+γ)", "Gy/h (γ)"])
        ]
